...
class Swe():
    ...
    #   reflectance - name of the input TOA reflectance HDF file to be processed
    #   mgt, mlt1, mlt2, b4lt1, b4lt2, b5lt1, b5lt2, per_slope - threashold values
    #       used in SWE algorithms
    ...
    #
    # Returns:
    #     ERROR - error running the DEM and SWE applications
    ...
    #      addition to the HDF-EOS product for the SWE algorithm.
    ...
    def runSwe (self, metafile=None, reflectance=None, mgt=None, 
                mlt1=None, mlt2=None, b4lt1=None, b4lt2=None, b5lt1=None, 
                b5lt2=None, per_slope=None, write_binary=None, 
        ...
        if use_zeven_thorne == None:
            parser.add_option("-z", "--use_zeven_thorne",
                  action="store_false", dest="use_zeven_thorne", default=False,
        ...
        cmdstr = "%sscene_based_swe --reflectance=%s --dem=%s --mgt=%f --mlt1=%f --mlt2=%f --b4lt1=%d --b4lt2=%d --b5lt1=%d --b5lt2=%d --per_slope=%f --write_binary --verbose" % (bin_dir, reflectance, dem.scene_dem_envi, mgt, mlt1, mlt2, b4lt1, b4lt2, b5lt1, b5lt2, per_slope)
#        cmdstr = "%sscene_based_swe --reflectance=%s --dem=%s --write_binary --use_fmask --verbose")
        print 'Executing: scene_based_swe command: %s' % cmdstr
